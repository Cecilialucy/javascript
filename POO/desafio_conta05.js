...
5. Poliformismo
   ...
   Tanto ContaOrigem quanto ContaDestino precisam ser instâncias de ContaBancaria.
   tanto CC quanto CP tem o método sacar(), que tem implementações diferentes.
   Mas como sabemos que ContaOrigem e ContaDestino possuem o método sacar(), independentemente se for CC ou CP podemos chamr esse método.
...
class Transferir {
    static execute(contaOrigem, ContaDestino, valor) {
        ...
        try {
            ...
            console.log("não autorizado", e.message)
        }
    }
}
