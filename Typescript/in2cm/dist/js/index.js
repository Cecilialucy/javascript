...
var centim = document.getElementById("centimeter"); //function convertToCm(e): FnListener {
//    console.log(thi.value)
//}

var convertToCm = function convertToCm(e) {
  console.log(this.value);
  centim.value = calculateCm(parseFloat(this.value)).toString();
};

var convertToIn = function convertToIn(e) {
